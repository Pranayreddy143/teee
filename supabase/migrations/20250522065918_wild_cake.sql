/*
  ...
  1. New Tables
    - `organizations`: Basic organization info and theme settings
    - `user_organizations`: Links users to organizations they have access to

  2. Changes
    - Add organization-related indexes
