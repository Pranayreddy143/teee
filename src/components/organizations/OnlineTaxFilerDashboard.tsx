...
import { Search, Building2, Calculator, CheckCircle2, Clock, Users, AlertCircle } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <div className="text-2xl font-bold text-white">OnlineTaxFiler</div>
